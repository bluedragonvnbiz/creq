...
<div class="border bg-white d-flex align-items-center justify-content-between camp-header">
	<div class="d-flex gap-15">
		<img class="object-fit-cover" src="http://localhost/creq/wp-content/themes/creq/assets/images/demo/demo-1.jpg" alt="" style="width:45px;height: 45px;border-radius: 5px;">
